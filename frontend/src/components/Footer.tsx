          ...
          {footerSections.map((section: Section) => (
            <div key={section.title} className="flex flex-col gap-4">
              ...
              <Button
                ...
                className="flex w-full items-center justify-between rounded-md bg-transparent pl-0 text-left text-lg font-semibold focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 focus-visible:outline-none lg:cursor-default"
                ...
                {section.links.map((link) => (
                  <div key={link.href || `span-${link.text}`} className="py-1">
                    {link.isSpan ? (
                      ...
                      <Link
                        className="rounded-md text-slate-600 hover:text-slate-900 focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 focus-visible:outline-none dark:text-slate-400 dark:hover:text-slate-100"
                        href={link.href || '/'}
          ...
          {footerIcons.map((social) => {
            ...
            return (
              <Link
                ...
                className="rounded-full p-2 text-slate-600 transition-colors duration-200 hover:text-slate-900 focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 focus-visible:outline-none dark:text-slate-400 dark:hover:text-slate-100"
              >
